...
const problems = [
  {
    ...
    title: "English-only leads = Lost leads",
    desc: "70% of Hispanics prefer doing business in Spanish. If your marketing is only in English, you're losing most of the market.",
  },
  {
    ...
    title: "Slow response = Cold lead",
    desc: "If you take more than 5 minutes to respond, conversion probability drops by 80%. Every second counts.",
  },
  {
    icon: <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
    title: "You pay for clicks, not results",
    desc: "Agencies charge monthly fees without guaranteeing real leads. You pay the same whether you convert or not.",
  },
];
    ...
    <section className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection className="text-center mb-16">
          <span className="inline-block bg-red-50 text-red-500 text-sm font-semibold px-4 py-1.5 rounded-full mb-4">The Problem</span>
          <h2 className="text-3xl md:text-4xl font-extrabold text-black">
            The Hispanic market is <span className="text-red-500">underserved</span>
          </h2>
          <p className="text-navy/50 mt-4 max-w-2xl mx-auto text-lg">
            Most agents ignore the Hispanic buyer. That&apos;s a huge opportunity for you.
          </p>
        </AnimatedSection>
          ...
          {problems.map((p, i) => (
            <AnimatedSection key={i} delay={i * 150} direction="up">
              <div className="group relative bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 h-full">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-red-50/0 to-sky-50/0 group-hover:from-red-50 group-hover:to-sky-50/50 transition-all duration-500" />
